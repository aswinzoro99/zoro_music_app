...
class CustomCurousalIndicator extends StatefulWidget {
  ...
  @override
  State<CustomCurousalIndicator> createState() =>
      _CustomCurousalIndicatorState();
}

class _CustomCurousalIndicatorState extends State<CustomCurousalIndicator>
  ...
  @override
  void didUpdateWidget(CustomCurousalIndicator oldWidget) {
...
abstract class BasePainter extends CustomPainter {
  final CustomCurousalIndicator widget;
  final double page;
  final Paint _paint;
...
class SlidePainter extends BasePainter {
  SlidePainter(CustomCurousalIndicator widget, double page, Paint paint)
